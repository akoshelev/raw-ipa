...
use rand::thread_rng;
use ipa_core::ff::boolean_array::{BA256, BA64, BA8};
use ipa_core::protocol::Gate;
use ipa_core::protocol::prss::{Endpoint, IndexedSharedRandomness, KeyExchange, SharedRandomness};
...
fn prss_benchmark(c: &mut Criterion) {
    if cfg!(debug_assertions) {
        panic!("Debug assertions enable PRSS generators to track used indices. This \
