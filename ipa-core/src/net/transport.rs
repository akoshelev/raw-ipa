...
impl MpcHttpTransport {
    ...
    pub fn new(
        ...
        let server = IpaHttpServer::new_mpc(Arc::clone(&inner_transport), server_config, network_config);
...
impl ShardHttpTransport {
    ...
    pub fn new(
        ...
        let server = IpaHttpServer::new_shards(Arc::clone(&inner_transport), server_config, network_config);
        (Self { inner_transport, shard_count } , server)
    }
}
